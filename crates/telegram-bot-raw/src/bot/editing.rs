...
impl Bot {
    ...
    pub async fn edit_message_live_location_raw(
        &self,
        latitude: f64,
        longitude: f64,
        chat_id: Option<ChatId>,
    ...
    pub async fn stop_message_live_location_raw(
        &self,
        chat_id: Option<ChatId>,
        message_id: Option<i64>,
        inline_message_id: Option<&str>,
    ...
    pub async fn edit_message_checklist_raw(
        &self,
