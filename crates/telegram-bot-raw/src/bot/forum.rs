...
impl Bot {
    ...
    pub async fn create_forum_topic_raw(
        &self,
        chat_id: ChatId,
        name: &str,
    ...
    pub async fn edit_forum_topic_raw(
        &self,
        chat_id: ChatId,
    ...
    pub async fn close_forum_topic_raw(
        &self,
        chat_id: ChatId,
        message_thread_id: i64,
    ) -> Result<bool> {
    ...
    pub async fn reopen_forum_topic_raw(
        &self,
        chat_id: ChatId,
        message_thread_id: i64,
    ) -> Result<bool> {
    ...
    pub async fn delete_forum_topic_raw(
        &self,
        chat_id: ChatId,
        message_thread_id: i64,
    ) -> Result<bool> {
    ...
    pub async fn unpin_all_forum_topic_messages_raw(
        &self,
        chat_id: ChatId,
        message_thread_id: i64,
    ) -> Result<bool> {
    ...
    pub async fn unpin_all_general_forum_topic_messages_raw(
        &self,
        chat_id: ChatId,
    ) -> Result<bool> {
    ...
    pub async fn edit_general_forum_topic_raw(&self, chat_id: ChatId, name: &str) -> Result<bool> {
        let params = vec![
            RequestParameter::new("chat_id", serde_json::to_value(&chat_id)?),
            RequestParameter::new("name", serde_json::Value::String(name.to_owned())),
        ];
    ...
    pub async fn close_general_forum_topic_raw(&self, chat_id: ChatId) -> Result<bool> {
        let params = vec![RequestParameter::new(
            "chat_id",
            serde_json::to_value(&chat_id)?,
        )];
    ...
    pub async fn reopen_general_forum_topic_raw(&self, chat_id: ChatId) -> Result<bool> {
        let params = vec![RequestParameter::new(
            "chat_id",
            serde_json::to_value(&chat_id)?,
        )];
    ...
    pub async fn hide_general_forum_topic_raw(&self, chat_id: ChatId) -> Result<bool> {
        let params = vec![RequestParameter::new(
            "chat_id",
            serde_json::to_value(&chat_id)?,
        )];
    ...
    pub async fn unhide_general_forum_topic_raw(&self, chat_id: ChatId) -> Result<bool> {
        let params = vec![RequestParameter::new(
            "chat_id",
            serde_json::to_value(&chat_id)?,
        )];
